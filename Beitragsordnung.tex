...
Der Chaos Computer Club Mannheim e.V. bietet seinen Mitgliedern die Option, eine Doppelmitgliedschaft mit dem Chaos Computer Club e.V. (CCC e.V.) einzugehen. Der Chaos Computer Club Mannheim e.V. übernimmt die Organisation der Mitgliedschaft, die sonst dem Mitglied obliegen würde.

\subsection{Beiträge}	
\label{doppelbeiträge}
\begin{enumerate}
	\item \label{doppeljahresbeitrag} Für Mitglieder, die die Doppelmitgliedschaft wählen, beträgt der Jahresbeitrag für den Chaos Computer Club Mannheim e.V. EUR 115,-.
...
\begin{enumerate}	
  \item Mitglieder, die die Doppelmitgliedschaft wählen, sind Mitglieder in beiden Vereinen mit sämtlilchen Rechten und Pflichten.
	\item Die Mitglieder bezahlen die Mitgliedsbeiträge für beide Vereine an den Chaos Computer Club Mannheim e.V., dieser leitet den Beitrag an den CCC e.V. weiter.
...
\section{Mitgliedsbeitrag des Chaos Computer Club Mannheim e.V.}
...
\begin{enumerate}
  ...
  \item Der Beitrag ist binnen vier Wochen nach Annahme des Aufnahmeantrages und folgend jeweils im Januar eines neuen Jahres unaufgefordert zu entrichten. Bei halbjährlicher Zahlungsweise ist der Beitrag jeweils im Januar und Juli zu entrichten.
